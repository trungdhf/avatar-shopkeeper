      ...
      <main id="home">
        ...
        <section className="shop-grid" id="shop" aria-label="Avatar shop">
          ...
          <div className="details-panel">
            ...
            <div><p className="product-kicker">THE FIRST DROP</p><h2>Tokyo Cap<span className="period">.</span></h2><p className="product-desc">A hip-hop cap with an ETHGlobal Tokyo 2026 patch. One unlock, three colors, endless good vibes.</p></div>
